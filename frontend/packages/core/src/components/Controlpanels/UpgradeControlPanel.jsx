...
import VersionOverview from '@portalbrasil/core/components/Controlpanels/VersionOverview';
...
const messages = defineMessages({
  ...
  upgradeInformation: {
    id: 'Upgrade portalbrasil.core',
    defaultMessage: 'Upgrade portalbrasil.core',
  },
  upgrade: {
